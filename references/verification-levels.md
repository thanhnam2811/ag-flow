...
The independent reviewer should receive the task contract, relevant diff/context, and verification entry points—not the implementer's full chain of reasoning.
